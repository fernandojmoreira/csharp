...
namespace TiposEVariaveis
{
    class Program
    {
        ...
        {
            int numero1 = 10; // declara uma variável inteira e armazena o valor dela
            int numero2 = 20;
            ...
            copiaDeNumero1 = 11; // sera que o valor será alterado ?
            ...
            var quadrado2 = quadrado1; // copiamos apenas a referência
            quadrado2.lado = 11;

            Console.WriteLine(quadrado1.lado); // deveria ter o lado = 10
            Console.WriteLine(quadrado2.lado); // deveria ter o lado = 11
        }
